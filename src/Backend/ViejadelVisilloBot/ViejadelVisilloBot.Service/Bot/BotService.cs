...
using ViejadelVisilloBot.Services.Authentication;
...
namespace ViejadelVisilloBot.Services.Bot
{
    ...
    /// Implements the <see cref="ViejadelVisilloBot.Services.Contract.IBotService" />
    /// </summary>
    /// <seealso cref="System.IDisposable" />
    /// <seealso cref="ViejadelVisilloBot.Services.Contract.IBotService" />
    public class BotService : IDisposable, IBotService
    {
        ...
        {
            ailogger.LogInformation($"SMARTBOT | BotService | Initialize");
        ...
        public async Task EndCallByCallLegIdAsync(string callLegId)
        {
            try
            {
                ailogger.LogInformation($"SMARTBOT | BotService | EndCallByCallLegIdAsync");
        ...
        {
            ailogger.LogInformation($"SMARTBOT | BotService | JoinCallAsync");
        ...
        private ILocalMediaSession CreateLocalMediaSession(Guid mediaSessionId = default)
        {
            try
            {
                ailogger.LogInformation($"SMARTBOT | BotService | CreateLocalMediaSession");
        ...
        {
            ailogger.LogInformation($"SMARTBOT | BotService | CallsOnIncoming");
        ...
        {
            ailogger.LogInformation($"SMARTBOT | BotService | CallsOnUpdated");

            foreach (var call in args.AddedResources)
            {
                var callHandler = new CallHandler(call, botConfiguration, ailogger);
        ...
        {
            ailogger.LogInformation($"SMARTBOT | BotService | GetHandlerOrThrow");
